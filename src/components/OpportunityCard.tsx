  ...
  return (
    <Card className="h-full flex flex-col transition-all duration-200 hover:shadow-md animate-fade-in">
      ...
      <CardFooter className="pt-2 flex justify-between items-center border-t border-gray-100">
        <p className="text-xs text-gray-400">Posted {formatDate(datePosted)}</p>
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              variant="outline"
              size="sm"
              className="text-volunteer-primary border-volunteer-primary hover:bg-volunteer-primary hover:text-white"
            >
              Details
            </Button>
          </DialogTrigger>
